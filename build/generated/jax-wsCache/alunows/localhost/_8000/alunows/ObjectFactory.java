 ...
 * generated in the localhost._8000.alunows package. 
...
public class ObjectFactory {
    ...
    private final static QName _Inserir_QNAME = new QName("http://localhost:8000/alunows", "inserir");
    private final static QName _Listar_QNAME = new QName("http://localhost:8000/alunows", "listar");
    private final static QName _AlterarResponse_QNAME = new QName("http://localhost:8000/alunows", "alterarResponse");
    private final static QName _InserirResponse_QNAME = new QName("http://localhost:8000/alunows", "inserirResponse");
    private final static QName _Remover_QNAME = new QName("http://localhost:8000/alunows", "remover");
    private final static QName _RemoverResponse_QNAME = new QName("http://localhost:8000/alunows", "removerResponse");
    private final static QName _ListarResponse_QNAME = new QName("http://localhost:8000/alunows", "listarResponse");
    private final static QName _Alterar_QNAME = new QName("http://localhost:8000/alunows", "alterar");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: localhost._8000.alunows
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://localhost:8000/alunows", name = "inserir")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://localhost:8000/alunows", name = "listar")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://localhost:8000/alunows", name = "alterarResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://localhost:8000/alunows", name = "inserirResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://localhost:8000/alunows", name = "remover")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://localhost:8000/alunows", name = "removerResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://localhost:8000/alunows", name = "listarResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://localhost:8000/alunows", name = "alterar")
